...
public class JavaWebServerMain {
    private final String DEFAULT_HOSTNAME = "10.80.162.95";
     ...
     * 생성자
     */
    public void javaWebServerMain() throws IOException {
        createServer(DEFAULT_HOSTNAME, DEFAULT_PORT);
    }
    public void javaWebServerMain(int port) throws IOException {
        createServer(DEFAULT_HOSTNAME, port);
    }
    public void javaWebServerMain(String host, int port) throws IOException {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 서버 생성
            httpServerManager = new javaWebServerMain("10.80.162.95", 3000);
